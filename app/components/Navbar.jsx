      ...
      <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-12">
        <div className="flex items-center justify-between h-16">
          <div className="flex-shrink-0">
            <img className="w-15 h-12" src="/imageTugu.png" alt="Logo" />
          </div>
          ...
          <div className="flex items-center gap-7">
            <a
              ...
              className="flex items-center gap-2 border border-transparent hover:border-gray-300 cursor-pointer duration-200 rounded-lg p-2"
            >
              <CiStar className="text-gray-200 text-xl hover:text-white" />
              <span className="text-gray-200 text-base hover:text-white">
                Star on Github
              </span>
            </a>
